    ...
    if (name == '' && url == tabs.activeTab.url) {
        switch (type){
            case 'start':
                    ...
                    readyTime = null;
                    loadTime = null;
                    tooltipPanel.port.emit('loading');
                break;
            ...
            case 'load':
                ...
                tooltipPanel.port.emit(
                    ...
                    [
                        ...
                        measure.getValues(tabs.activeTab.url+'#load'),
                        measure.getAvgs(tabs.activeTab.url+'#load')
                    ]
                );
...
tooltipPanel.port.on('clear', function(){
    measure.clear(tabs.activeTab.url);
    measure.clear(tabs.activeTab.url+'#load');
    
    tooltipPanel.port.emit('reloadContent',
        tabs.activeTab.url,
        [
            measure.getValues(tabs.activeTab.url),
            measure.getAvgs(tabs.activeTab.url),
